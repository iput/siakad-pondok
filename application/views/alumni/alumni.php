  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo base_url('Alumni/Alumni/DataDiri') ?>"><i class="fa fa-user-secret"></i> Data Diri</a></li>
        <li><a href="<?php echo base_url('Alumni/Alumni/DataWali') ?>"><i class="fa fa-users"></i> Data Wali</a></li>
        <li><a href="<?php echo base_url('Alumni/Alumni/riwayatPendidikan') ?>"><i class="fa fa-trophy"></i> Riwayat Pendidikan</a></li>
        <li><a href="<?php echo base_url('Alumni/Alumni/saranMasukan') ?>"><i class="fa fa-envelope-o"></i> Saran dan Masukan</a></li>
